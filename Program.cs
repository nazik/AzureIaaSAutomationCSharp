...
namespace ManagementLibrariesDemo
{
    class Program
    {
        ...
        //1.Visual Studio 2013 Community Edition or above https://www.visualstudio.com/en-us/products/visual-studio-community-vs


        //2.Download the following credential file .publishsettings which has the Base64 azure management certificate from this link 
        //  https://manage.windowsazure.com/publishsettings. You will need an Azure Subscription to download the file. You can sign 
        ...
        static string subscriptionName = "[Subscription name]";                                 // Optional(You can keep it as is). Name of the Azure subscription
